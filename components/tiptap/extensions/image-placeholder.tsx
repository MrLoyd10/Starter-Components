          ...
          <Tabs defaultValue="upload" className="px-3">
            ...
            <TabsContent value="upload">
              ...
              >
                ...
                <label
                  htmlFor="file-input"
                  className="flex flex-col justify-center items-center w-full h-28 text-center cursor-pointer"
                >
            ...
            <TabsContent value="url">
              <form onSubmit={handleInsertEmbed}>
                ...
                <Button
                  ...
                  type="button"
                  size="sm"
                  className="my-2 p-2 w-full h-8 text-xs"
                >
                  Embed Image
                </Button>
