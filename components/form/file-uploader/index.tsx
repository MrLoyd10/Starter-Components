...
import { useControllableState } from "@/components/form/file-uploader/hooks/use-controllable-state";
...
interface FileUploaderProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /**
   *  Display text that can be accepted
   *  @example acceptText="PNG, JPEG, JPG, WEBP"
   */
  acceptText?: string;
}
